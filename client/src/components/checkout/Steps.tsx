...
function Steps({
  ...
  return (
    <div className="relative mt-6 max-sm:pt-4 mb-24 max-sm:mb-12">
      {/* Progress Bar */}
      ...
      <div className="relative z-10 flex justify-between">
        <div className="flex justify-center items-center">
          <span
            className={`h-10 w-10 max-sm:w-6 max-sm:h-6 ${
          ...
          >
            <FaMapMarkerAlt
              className={`text-2xl max-sm:text-sm ${
                currentStep >= 1 ? "text-background" : "text-yellow-600"
              }`}
            />
          </span>
          <div
          ...
          >
            ...
            <p className="text-base max-sm:text-xs font-semibold">Address</p>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <FaShippingFast
              className={`text-2xl max-sm:text-sm ${
                currentStep >= 2 ? "text-background" : "text-yellow-600"
              }`}
            />
          </span>
          <div
          ...
          >
            ...
            <p className="text-base max-sm:text-xs font-semibold">Shipping</p>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center">
          ...
          >
            <FaCreditCard
              className={`text-2xl max-sm:text-sm ${
                currentStep >= 3 ? "text-background" : "text-yellow-600"
              }`}
            />
          </span>
          <div
          ...
          >
            ...
            <p className="text-base max-sm:text-xs font-semibold">Payment</p>
          </div>
        </div>
      </div>
    </div>
